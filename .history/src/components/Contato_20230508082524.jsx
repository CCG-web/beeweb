...
const Contato = () => {
    return (
        ...
        <div className="itensForm Secord">
            <ul>
                <li className="listContact"> <i><BsFillTelephoneFill/></i> contato@plataformacidts.com</li>
                <li className="listContact">(85)import { BsFillTelephoneFill } from 'react-icons/bs'; 9 8956.6689</li>
